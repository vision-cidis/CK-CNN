...
traindata = trdata.flow_from_directory(directory="dataset2class/training_set/training_set",target_size=(224,224),batch_size=64) #batch size
...
testdata = tsdata.flow_from_directory(directory="dataset2class/test_set/test_set", target_size=(224,224),batch_size=64)
...
checkpoint = ModelCheckpoint("weights.h5", monitor='val_accuracy', verbose=1, save_best_only=False, save_weights_only=False, mode='auto', period=5)
